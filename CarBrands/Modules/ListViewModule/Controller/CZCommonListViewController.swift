...
extension CZCommonListViewController {
    ...
    private func applySnapshot(_ manufacturer: [Model]) {
        ...
        // Due to Diffable data source behavior, when a new snapshot is applied, the cells which are existing in the previous snapshot will not be loaded again. Due to which alternating row colors might mismatch. hence manually updating the cell's background color during the search process.
